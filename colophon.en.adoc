...
* Saara Suominen, mailto:s.suominen@unesco.org[s.suominen@unesco.org], Ocean Biodiversity Information System, Jacobsenstraat 1, 8400 Oostende, Belgium
...
This version adjusts guidance in response to the CBD COP [Decision 16/2 on digital sequence information](https://www.cbd.int/doc/decisions/cop-16/cop-16-dec-02-en.pdf); see [Making DNA-derived data accessible and accountable](https://www.gbif.org/news/3OYkPINuWGy3U6k2ezbuDU) for context.
