...
Andersson AF, Bissett A, Finstad AG, Fossøy F, Grosjean M, Hope M, Jeppesen TS, Kõljalg U, Lundin D, Nilsson RN, Prager M, Svenningsen C, Schigel D, Suominen S & Frøslev TG (2023) Publishing DNA-derived data through biodiversity data platforms. v1.3 Copenhagen: GBIF Secretariat. https://doi.org/10.35035/doc-vf1a-nr22.
...
Version 1.2.0 released on XXX. This version has an added paragraph on Marine datasets and the Ocean Biodiversity Information System (OBIS), and some minor text edits throughout the document. 
