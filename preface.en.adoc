...
The authors are aware of but did not yet consult the http://www.boldsystems.org/index.php/Resource[BOLD Handbook], http://biom-format.org[BIOM format] and http://edamontology.org/page.
